...
export default function Footer() {
  ...
  return (
    <footer
      id="main-app-footer"
      className="relative bg-[#06080d] border-t border-zinc-900 pt-20 pb-10 overflow-hidden"
    >
      {/* Massive Stroke Watermark */}
      <div className="absolute bottom-0 right-1/2 translate-x-1/2 md:translate-x-0 md:right-10 pointer-events-none select-none text-[15vw] sm:text-[18vw] font-black leading-none opacity-[0.02] tracking-[0.15em] text-luxury-gold text-center uppercase whitespace-nowrap z-0 font-mono">
        CEOHIVE
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-12 z-10 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 pb-16 border-b border-zinc-900">
        ...
        <div className="md:col-span-5 flex flex-col items-start">
          ...
          <div className="flex items-center gap-2.5 bg-[#101422]/60 border border-zinc-800/40 px-3 py-1.5 rounded text-[10px] font-mono tracking-widest text-luxury-gold">
        ...
        <div className="md:col-span-3 flex flex-col">
          <span className="font-mono text-[10px] tracking-[0.2em] text-luxury-gold uppercase font-bold mb-4">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-12 z-10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-mono text-zinc-600">
        ...
        <div className="flex gap-4">
          <span className="text-luxury-gold/50 select-none">SYSTEMS OPERATIONAL // WCAG 2.1 AA COMPLIANT</span>
        </div>
      </div>
    </footer>
  );
