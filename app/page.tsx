          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-7 flex flex-col items-start">
              ...
              <div className="mt-16 grid grid-cols-3 gap-6 border-t border-zinc-900 pt-8 w-full max-w-lg">
                <div>
                  <div className="font-mono text-3xl font-bold text-luxury-gold">
                    {statistics.clients}+
                  </div>
                ...
                <div>
                  <div className="font-mono text-3xl font-bold text-luxury-gold flex items-center">
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-12 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="glass-panel p-8 rounded border border-zinc-800/60 glass-card-hover group interactive-card flex flex-col justify-between min-h-[280px]">
                <div>
                  <div className="flex justify-between items-start mb-6">
                    <div className="w-12 h-12 flex items-center justify-center border border-luxury-gold/20 bg-luxury-gold/5 rounded text-luxury-gold group-hover:border-luxury-gold/40 transition-colors">
              ...
              <div className="glass-panel p-8 rounded border border-zinc-800/60 glass-card-hover group interactive-card flex flex-col justify-between min-h-[280px]">
                ...
                <Link
                  href="/services"
                  className="font-mono text-[10px] uppercase font-bold tracking-widest text-luxury-gold hover:text-white flex items-center gap-1 mt-4 animate-none"
                >
                  Audit Specs ➔
                </Link>
              </div>
